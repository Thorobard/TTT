...
def restart_game():
    global list_game_state, list_btn, victory, turn, bool_ai_vs_ai, move_count, data_list, keine_ahnung
    keine_ahnung.destroyer()
    list_game_state = []
    list_btn = []
    victory = False
    turn = False
    bool_ai_vs_ai = False
    keine_ahnung = Button_Attributes() 
...
#-----------------------------------------------------------------------------------------------------
    ...
    global victory_label, keine_ahnung
