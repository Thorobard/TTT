...
class Button_TTT:
    ...
    def change_color_ttt_btn(self):
        global turn, red_score, yellow_score
...
def start_game():
    global list_game_state, list_btn, victory, turn
    list_game_state = []
    list_btn = []
    victory = False
    turn = False
...
def main():
    ...
    ai_vs_ai_button = tk.Button(win, font=('Comic Sans MS', 20), background='Black', text="Ai vs Ai", foreground="Skyblue")
